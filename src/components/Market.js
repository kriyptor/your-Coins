...
function Market({ coins, gainerCoins, losserCoins, setUpdateCoinName, handleClickUpdate }) {
  ...
  return (
    <>
      ...
      {value === 0 &&
      <>
       <TextField id="outlined-basic" label="Search Coin" variant="outlined" className={classes.search} onChange={handleSearch}/>
        {filteredCoins.map((c) => (
          <MarketPaper
            key={c.id}
            name={c.name}
